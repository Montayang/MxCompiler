...
if_withoutelse_end_basicblock:                               ; preds = entrance_block0 single_then_basicblock 
    %i = load i32, i32* @i
    %p_1 = load i32, i32* @p
    %k_1 = load i32, i32* @k
...
short_circuit_AND_end_AND:                                   ; preds = short_circuit_AND_branch_AND for_body 
...
if_withoutelse_end_basicblock0:                              ; preds = short_circuit_AND_end_AND single_then_basicblock0 if_end_basicblock 
    br label %for_step
...
if_withoutelse_end_basicblock1:                              ; preds = for_end_merge single_then_basicblock1 
